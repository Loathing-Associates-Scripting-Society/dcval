...
var toAbsoluteIndex = __webpack_require__(786); // `Array.prototype.{ indexOf, includes }` methods implementation
...
var has = __webpack_require__(551);

var ownKeys = __webpack_require__(813);

var getOwnPropertyDescriptorModule = __webpack_require__(609);
...
var fails = __webpack_require__(901); // Detect IE8's incomplete defineProperty implementation
...
var redefine = __webpack_require__(486);

var setGlobal = __webpack_require__(351);

var copyConstructorProperties = __webpack_require__(780);

var isForced = __webpack_require__(612);
/*
...
var fails = __webpack_require__(901);

var createElement = __webpack_require__(603); // Thank's IE8 for his funny defineProperty
...
var NATIVE_WEAK_MAP = __webpack_require__(770);
...
var objectHas = __webpack_require__(551);

var shared = __webpack_require__(153);

var sharedKey = __webpack_require__(449);
...
var inspectSource = __webpack_require__(599);
...
var IE8_DOM_DEFINE = __webpack_require__(674);

var anObject = __webpack_require__(739);

var toPrimitive = __webpack_require__(375); // eslint-disable-next-line es/no-object-defineproperty -- safe
...
var propertyIsEnumerableModule = __webpack_require__(395);
...
var IE8_DOM_DEFINE = __webpack_require__(674); // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
...
var propertyIsEnumerable = (__webpack_require__(395).f); // `Object.{ entries, values }` methods implementation
...
var getBuiltIn = __webpack_require__(575);

var getOwnPropertyNamesModule = __webpack_require__(166);

var getOwnPropertySymbolsModule = __webpack_require__(863);

var anObject = __webpack_require__(739); // all object keys, includes non-enumerable and symbols
...
var shared = __webpack_require__(849);
...
var IS_PURE = __webpack_require__(719);
...
var IndexedObject = __webpack_require__(483);

var requireObjectCoercible = __webpack_require__(682);
...
var requireObjectCoercible = __webpack_require__(682); // `ToObject` abstract operation
...
var isObject = __webpack_require__(949); // `ToPrimitive` abstract operation
...
var es_object_entries = __webpack_require__(875);
...
function main(arg) {
  ...
  while ((items = dcCheck.exec(page)) !== null) {
    if (!items[1].includes("(")) {
      var cleanItem = items[1].slice(0, items[1].indexOf("</b>"));

      if (!Item.get(cleanItem).tradeable) {
        (0,external_kolmafia_namespaceObject.print)("".concat(cleanItem, " is untradeable"));
      } else {
        // print(`${cleanItem}`);
      ...
      var name = items[1].slice(0, items[1].indexOf("> (") - 3); // print(`${name}`);

      if (!Item.get(name).tradeable) {
        (0,external_kolmafia_namespaceObject.print)("".concat(name, " is untradeable"));
      } else {
        var q = items[1].slice(items[1].indexOf("(") + 1, items[1].indexOf(")"));
        var quantity = q.replace(/,/g, ""); // print(`${quantity.replace(/,/g, "")}`);

        if (parseInt(quantity)) {
          var _value = (0,external_kolmafia_namespaceObject.mallPrice)(Item.get(name)); //  print(`${parseInt(quantity.replace(/,/g, ""))}`);
